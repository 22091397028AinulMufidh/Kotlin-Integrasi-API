...
import com.example.homeactivity.databinding.ActivityFavoriteDetailBinding
...
class FavoriteDetailActivity : AppCompatActivity() {
    ...
    private fun toggleFavorite() {
        if (isFavorite) {
            ...
            isFavorite = false
            binding.fabFavorite.setImageResource(R.drawable.favorite_border) // Ganti icon untuk tidak favorit
        } else {
            // Tambah ke favorit
            favoriteViewModel.insertFavoriteEvent(favoriteEvent)
            isFavorite = true
            binding.fabFavorite.setImageResource(R.drawable.favorite) // Ganti icon untuk favorit
        }
    }
